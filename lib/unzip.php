...
// Anzeige der zip-Dateien im aktuellen Verzeichnis (Dropdown-men¸) -> Auswahl -> entpacken im ./ Verzeichnis
//
// --------------------------------------------------------------------------------
...
echo '<form action="'.$_SERVER['PHP_SELF'].'" method="post"><select name="archive">';
if ($handle = opendir('.')) {
    while (false !== ($file = readdir($handle))) {
        if (preg_match("/.zip$/i", $file)) {      // nur Dateien mit der Endung .zip werden angezeigt - egal ob .zip groﬂ oder klein geschrieben ist
